...
const ClassUserManagement = () => {
  ...
  const filteredUsers = classUsers.filter(
    (user) =>
    ...
    try {
      ...
      if (editingUser) {
        ...
        if (response.ok) {
          ...
          toast("Teacher details have been updated successfully.");
        }
      } else {
        ...
        if (response.ok) {
          ...
          toast("New teacher has been created successfully.");
        }
      }
    } catch {
  ...
  const handleDelete = async (userId: string) => {
    try {
      ...
      if (response.ok) {
        ...
        toast.error("Teacher has been removed from the system.");
      }
    } catch {
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {classUsers.filter((u) => u.status === "active").length}
                </p>
              </div>
              <Badge
                variant="default"
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {classUsers.reduce((sum, u) => sum + u.studentCount, 0)}
                </p>
              </div>
