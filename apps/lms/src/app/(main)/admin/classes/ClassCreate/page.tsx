          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Class Code</FormLabel>
                      <FormControl>
                        <Input placeholder="MATH-301" {...field} />
                      </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Description</FormLabel>
                    <FormControl>
                      <Textarea placeholder="Detailed description..." className="min-h-[100px]" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Class meeting times</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
              ...
              <div className="flex gap-4">
                ...
                <Button type="button" variant="outline" asChild>
                  <Link href="/admin/classes/list">Cancel</Link>
                </Button>
              </div>
            </form>
          </Form>
