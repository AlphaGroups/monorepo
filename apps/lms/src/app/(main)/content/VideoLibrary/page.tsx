...
const mockVideos: Video[] = [
  {
    ...
    description:
      "Learn the fundamentals of derivatives in calculus with step-by-step examples and clear explanations.",
  ...
  },
  {
    ...
    description:
      "A comprehensive introduction to quantum physics concepts, quantum mechanics, and their real-world applications.",
  ...
  },
  {
    ...
    description:
      "Master organic chemistry reaction mechanisms with detailed explanations and molecular structure analysis.",
  ...
  const onSubmit = async (data: VideoFormData) => {
    try {
      ...
      if (response.ok) {
        ...
        toast("Video has been successfully added to the library.");
      }
    } catch {
